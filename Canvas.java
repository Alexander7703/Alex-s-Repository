 ...
 *  This is the object-oriented version of standard princeton; it supports
...
public class Canvas extends JLabel {
    ...
    public enum STROKE_TYPE  {Solid,Dashed,Dotted}
    ...
    // refresh we princeton immediately or wait until next refresh?
    ...
    public void setStroke(STROKE_TYPE stroke){
        BasicStroke bStroke=null;
        switch(stroke){
            case Solid:
                bStroke = new BasicStroke((float) penRadius, BasicStroke.CAP_ROUND, BasicStroke.JOIN_ROUND);
                break;
            case Dashed:
                bStroke = new BasicStroke((float) penRadius, BasicStroke.CAP_BUTT, BasicStroke.JOIN_BEVEL, 0, new float[]{9}, 0);
                break;
            case Dotted:
                bStroke = new BasicStroke((float) penRadius, BasicStroke.CAP_BUTT, BasicStroke.JOIN_BEVEL, 0, new float[] {1,2}, 0);
            break;
        }
        offscreen.setStroke(bStroke);
    }
    ...
    /**
     * Draws a square of side segment 2r, centered on (x, y).
     *
     * @param  x the x-coordinate of the center of the square
     * @param  y the y-coordinate of the center of the square
     * @param  r radius is half the segment of any side of the square
     * @throws IllegalArgumentException if r is negative
     */
    public void square(double x, double y, double r) {
        if (r < 0) throw new IllegalArgumentException("square side segment can't be negative");
        double xs = scaleX(x);
        double ys = scaleY(y);
        double ws = factorX(2*r);
        double hs = factorY(2*r);
    ...
    /**
     * Draws a filled square of side segment 2r, centered on (x, y).
     *
     * @param  x the x-coordinate of the center of the square
     * @param  y the y-coordinate of the center of the square
     * @param  r radius is half the segment of any side of the square
     ...
     * @param  x the center x-coordinate of the image
     * @param  y the center y-coordinate of the image
     * @param  image the name of bufferedImage
     * @throws IllegalArgumentException if the image is corrupt
     * @throws IllegalArgumentException if {@code filename} is {@code null}
     */
     ...
     * to refresh(). Useful for animations.
     */
